...
/// <summary>Pregunta a GitHub la última release publicada: consulta anónima, de sólo lectura, sin nada que identifique al usuario ni al equipo.</summary>
public sealed class ConsultorDeReleases : IDisposable
{
    /// <summary>Lo único que va en el <c>User-Agent</c>: ni versión ni ningún otro dato.</summary>
