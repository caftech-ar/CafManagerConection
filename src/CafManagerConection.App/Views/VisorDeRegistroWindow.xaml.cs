...
/// <summary>De dónde saca un visor el registro que muestra: leerlo entero, decir qué archivos mira y seguirlos.</summary>
...
/// <summary>Visor de un registro remoto que se sigue en vivo, declara qué archivos mira y avisa cuando algo se rompe.</summary>
...
public partial class VisorDeRegistroWindow : Window
{
    ...
    /// <summary>Escribe cada línea con el color de su nivel, para no perder el error entre miles de líneas.</summary>
    ...
    /// <returns>Si la línea es de error, para poder contarlas.</returns>
    ...
    /// <summary>Dice qué archivos se están mirando y cuándo cambió cada uno.</summary>
    ...
    /// <summary>El canal se cerró por su cuenta: hay que decirlo o el registro queda congelado sin avisar.</summary>
    ...
    /// <summary>El aviso vive en la ventana y no en el registro: tiene que verse aunque el usuario esté en otra pestaña.</summary>
    ...
    /// <summary>Relee el archivo de verdad y vuelve a dibujar: no alcanza con repintar lo que ya estaba.</summary>
    ...
    /// <summary>Abre el visor sin bloquear la sesión: seguir en vivo dentro de una ventana modal no sirve de nada.</summary>
