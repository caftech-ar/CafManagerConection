...
public sealed record DetalleDeContenedor
{
    ...
    /// <summary>Distingue «el registro vino vacío» de «no se pudo leer».</summary>
    ...
    /// <summary>Mismo criterio que <see cref="ContainerInfo.Gravedad"/>, pero acá la salud viene en su propio campo.</summary>
    ...
    public static DetalleDeContenedor Interpretar(string nombre, string salida)
    {
        ...
        return detalle with
        {
            ...
            // La marca del registro en la salida dice que el comando corrió: sin ella, no llegó a ejecutarse.
