...
// Aparte de PlatformInventory: no existe ningún método que escriba, y no tiene acciones a propósito.
public sealed class ConsultorDeProcesos
{
    ...
    /// <summary>Sólo dígitos y con tope: el PID vuelve a entrar en una línea que puede correr como root.</summary>
        ...
        int pid, string nombre, CancellationToken ct = default)
    {
        ...
        // Los errores van a la salida normal: sin permisos readlink escribe ahí el motivo.
