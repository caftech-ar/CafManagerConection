...
public sealed class Connection
{
    ...
    /// <summary>Si esta fila tiene contraseña guardada. En falso, la herencia sigue subiendo. Nunca es el secreto.</summary>
    ...
    /// <summary>Conexión de la que ésta cuelga; el único nivel lo verifica <c>ConnectionValidator</c>.</summary>
    ...
    /// <summary><c>null</c> cae en el color global del protocolo. No se hereda.</summary>
    public string? ClaveDeColor { get; set; }

    /// <summary><c>null</c> usa el icono del protocolo. No se hereda.</summary>
    ...
    /// <summary>Etiqueta del catálogo, por identificador; <c>null</c> hereda la de la carpeta.</summary>
