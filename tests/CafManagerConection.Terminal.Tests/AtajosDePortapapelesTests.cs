...
/// <summary>Qué teclas se queda la aplicación y cuáles van al servidor.</summary>
public sealed class AtajosDePortapapelesTests
{
    ...
    /// <summary>La lista es cerrada: todo lo que no está reservado llega al servidor.</summary>
    [Theory]
