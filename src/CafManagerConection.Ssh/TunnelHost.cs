...
/// <summary>Levanta y detiene los reenvíos de puerto local de una conexión.</summary>
public sealed class TunnelHost : IAsyncDisposable
{
    ...
    /// <summary>Levanta los túneles marcados para arrancar solos; si uno falla, los demás se levantan igual.</summary>
