...
public sealed class SondaDeSudo(EjecutorRemoto ejecutar)
{
    ...
    // Un sudo fallido de quien no está en sudoers deja una línea en el registro del servidor y le manda un correo a root: repetirlo por panel convierte un sondeo en una alarma.
