...
/// <summary>Qué se le asigna al ActiveX con el tilde de identidad de Windows y sin él. No instancia el control: el plan es una decisión, no una llamada a COM.</summary>
public sealed class IdentidadDeWindowsTests
{
    private static RdpSessionRequest Pedido(bool identidad, string usuario = "operador") => new(
        ...
        ModoDeTamano: Domain.Connections.ModoDeTamanoRdp.EscalarPixeles,
