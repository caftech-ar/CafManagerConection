...
{
    private static byte[] ClaveDePrueba()
    {
        var clave = new byte[CifradoDeSecretos.LargoDeLaClave];
        System.Security.Cryptography.RandomNumberGenerator.Fill(clave);
        return clave;
    }
    ...
    {
        var sobre = CifradoDeSecretos.CifrarTexto(ClaveDePrueba(), Secreto);

        Assert.Throws<AuthenticationTagMismatchException>(
            () => CifradoDeSecretos.DescifrarTexto(ClaveDePrueba(), sobre));
    }
    ...
    public void Un_sobre_con_forma_invalida_se_rechaza_antes_de_intentar_descifrar()
    {
        ...
        Assert.Throws<CryptographicException>(
            () => CifradoDeSecretos.Descifrar(ClaveDePrueba(), sobre));
    }
    ...
    public void La_misma_clave_maestra_y_la_misma_sal_dan_la_misma_clave()
    {
        ...
        var una = CifradoDeSecretos.Derivar("Zorro-Verde-2026!", sal, 1000, CifradoDeSecretos.HashPorOmision);
        var otra = CifradoDeSecretos.Derivar("Zorro-Verde-2026!", sal, 1000, CifradoDeSecretos.HashPorOmision);
    ...
    {
        var una = CifradoDeSecretos.Derivar("Zorro-Verde-2026!", CifradoDeSecretos.SalNueva(), 1000, CifradoDeSecretos.HashPorOmision);
        var otra = CifradoDeSecretos.Derivar("Zorro-Verde-2026!", CifradoDeSecretos.SalNueva(), 1000, CifradoDeSecretos.HashPorOmision);
    ...
    public void Otra_cantidad_de_iteraciones_da_otra_clave()
    {
        ...
        var una = CifradoDeSecretos.Derivar("Zorro-Verde-2026!", sal, 1000, CifradoDeSecretos.HashPorOmision);
        var otra = CifradoDeSecretos.Derivar("Zorro-Verde-2026!", sal, 2000, CifradoDeSecretos.HashPorOmision);
    ...
    {
        var derivada = CifradoDeSecretos.Derivar("Zorro-Verde-2026!", CifradoDeSecretos.SalNueva(), 1000, CifradoDeSecretos.HashPorOmision);
    ...
    public void Una_clave_maestra_con_acentos_y_emoji_va_y_vuelve()
    {
        ...
        var sal = CifradoDeSecretos.SalNueva();
        var clave = CifradoDeSecretos.Derivar(ConTodo, sal, 1000, CifradoDeSecretos.HashPorOmision);
        var sobre = CifradoDeSecretos.CifrarTexto(clave, Secreto);

        var otraVez = CifradoDeSecretos.Derivar(ConTodo, sal, 1000, CifradoDeSecretos.HashPorOmision);
    ...
    {
        Assert.NotEqual(
            Convert.ToHexString(ClaveDePrueba()),
            Convert.ToHexString(ClaveDePrueba()));
    }
