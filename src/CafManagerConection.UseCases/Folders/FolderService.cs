...
public sealed class FolderService
{
    ...
    /// <summary>Ordena alfabéticamente los hijos directos y nada más: el contenido de las subcarpetas conserva su orden manual.</summary>
    ...
    /// <summary>Mueve la carpeta y le deja su lugar dentro del destino; sin <paramref name="posicion"/> va al alfabético.</summary>
    ...
    private static bool Difieren(EffectiveSettings antes, EffectiveSettings despues) =>
        ...
        antes.Secreto.Value != despues.Secreto.Value ||
    ...
    private static bool HeredaCredencialCambiada(
        ...
        antes.Secreto.SourceFolderId == folderId;
    ...
    public async Task<OperationResult> DeleteAsync(Guid id, CancellationToken ct = default)
    {
        ...
        // Los secretos viven en la fila de cada conexion y en la de los ajustes de cada carpeta,
        // asi que se van con la cascada del borrado. Antes habia que averiguar cuales quedaban
        // huerfanos porque una clave logica podia estar compartida.
