...
/// <summary>Ficha de un contenedor: qué es, cómo está, qué consume y qué dice su registro.</summary>
...
public partial class ContenedorWindow : Window
{
    ...
    /// <summary>Dice qué se está monitoreando y cuándo llegó lo último: un registro congelado y un contenedor tranquilo se ven igual.</summary>
    ...
    /// <summary>El aviso vive en la ventana y no entre las líneas del registro: tiene que verse aunque el usuario esté en otra pestaña.</summary>
    ...
    /// <summary>Abre el canal de seguimiento del registro del contenedor. Si el canal se cierra por su cuenta —el contenedor se detuvo, o la conexión se cortó— el botón de parar vuelve a su estado inicial.</summary>
    ...
    /// <summary>Dibuja el registro de la última consulta, con cada línea en el color de su nivel.</summary>
    ...
    /// <summary>Una línea que llegó del canal en vivo: además de dibujarla, hay que avisar si trae un error.</summary>
    ...
    /// <summary>Relee el registro del servidor y lo vuelve a dibujar, aunque se lo esté siguiendo en vivo.</summary>
