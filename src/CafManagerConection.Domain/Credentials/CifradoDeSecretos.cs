...
public static class CifradoDeSecretos
{
    ...
    /// <summary>Piso del proyecto. Una fila con menos se rechaza en lugar de derivar barato.</summary>
    public const int IteracionesMinimas = 600_000;

    public static readonly HashAlgorithmName HashPorOmision = HashAlgorithmName.SHA512;

    public static readonly IReadOnlyList<string> HashesAdmitidos = ["SHA512"];
    ...
    public static byte[] Derivar(
        ReadOnlySpan<char> claveMaestra, ReadOnlySpan<byte> sal, int iteraciones, HashAlgorithmName hash)
    {
