...
/// <summary>Compara por componentes numéricos y no como texto: <c>0.0.10</c> es posterior a <c>0.0.9</c>.</summary>
...
{
    /// <summary>Posponer silencia el aviso hasta el día siguiente y sólo para esa versión.</summary>
