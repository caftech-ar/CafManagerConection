...
// El panel de procesos es de sólo lectura. Se lee el fuente como texto, igual que
...
public sealed class ProcesosPanelDeSoloLecturaTests
{
    ...
    // El único botón del panel es el de escalar privilegios, que también es de lectura.
    [Fact]
