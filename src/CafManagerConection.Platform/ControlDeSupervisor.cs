...
// Aparte de PlatformInventory: la garantía de sólo lectura del inventario es que no tiene métodos de escritura.
public sealed class ControlDeSupervisor
{
        ...
        AccionDeProceso accion, string proceso, CancellationToken ct = default)
    {
        ...
        // Se registra la acción y no el nombre del proceso: es contenido de sesión.
