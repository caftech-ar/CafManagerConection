...
public sealed class VtEmulator
{
    ...
    /// <summary>Modo 2004: la aplicación remota quiere que el texto pegado llegue marcado.</summary>
    ...
    private void Osc(char c)
    {
        if (c == '\a' || c == '\x1b')
        {
            ...
            // El terminador ST son 2 bytes (ESC y barra invertida): volviendo a Ground, la barra invertida caía como texto y se imprimía suelta.
