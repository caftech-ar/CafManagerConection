...
// Hasta ahora IFolderRepository no tenía ReorderAsync y las carpetas no se reordenaban.
public class FolderRepositoryReorderTests
{
        ...
        CrearAsync()
    {
        ...
        return (db, carpetas, new FolderService(carpetas, conexiones, new AlmacenEnMemoria()));
    }
