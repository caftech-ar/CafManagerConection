...
public sealed class SinDatosRealesTests
{
    ...
    [
        // Reservados por la RFC 2606; `ejemplo.com` y `dominio.com` son los marcadores en castellano.
        "example.com", "example.org", "example.net", "ejemplo.com", "dominio.com",

        // Sitios de verdad que el proyecto puede citar: el suyo y los de sus dependencias.
    ...
    private static IEnumerable<string> Revisables(string raiz)
    {
        string[] carpetas =
        [
            "src", "tests", "scripts", "build", "installer", ".github", ".claude", "openspec",
        ];
