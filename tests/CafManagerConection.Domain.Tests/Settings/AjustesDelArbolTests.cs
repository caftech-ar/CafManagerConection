...
// Escala de tamaño de letra del árbol y su acotado. Esta prueba es hoy la única
// definición de la regla, y el único lugar donde se prueba el acotado: la
// infraestructura confía en que ya hizo el trabajo.
