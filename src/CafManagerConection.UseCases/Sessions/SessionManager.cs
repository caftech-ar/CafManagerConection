...
public sealed class SessionManager
{
    ...
    /// <summary>Abre una sesión; sin <paramref name="forceNew"/> trae al frente la que ya está.</summary>
    ...
    // Cada cierre va aislado, una sesión que explota no puede colgar el cierre de las demás.
