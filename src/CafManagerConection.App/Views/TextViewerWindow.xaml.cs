...
/// <summary>Visor de sólo lectura para texto estático de un servidor, como la configuración efectiva de nginx. Un registro no se muestra acá: se sigue en vivo en <see cref="VisorDeRegistroWindow"/>.</summary>
...
public partial class TextViewerWindow : Window
{
    ...
    /// <summary>Muestra un archivo de configuración con resaltado de sintaxis, en modal y sin seguir nada.</summary>
