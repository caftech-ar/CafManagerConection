...
/// <summary>Un archivo que un visor declara estar siguiendo, con la fecha de su último cambio.</summary>
...
/// <summary>Arma los comandos que siguen un archivo de registro y lee lo que el servidor contesta.</summary>
public static class SeguimientoDeArchivo
{
    ...
    /// <summary>Lo que dice <c>tail</c> cuando el archivo rota o deja de poder leerse; null si la línea es del registro.</summary>
