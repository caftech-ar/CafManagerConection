...
public sealed class CollectorTests
{
    ...
    // El top salía de ps --sort=-pcpu, que informa el promedio de toda la vida del proceso; ahora sale de la muestra de /proc del ColectorDeProcesos.
    [Fact]
    ...
    /// <remarks>La línea de comando de un proceso no se pide, por las contraseñas
