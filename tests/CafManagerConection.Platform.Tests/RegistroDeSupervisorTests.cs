...
{
    private sealed class RunnerPorCanal(string stderr, string stdout) : IEjecutorConPrivilegios
    {
    ...
    private static PlatformInventory Inventario(IEjecutorConPrivilegios runner) => new(runner);
