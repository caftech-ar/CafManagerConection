...
/// <summary>La capa de aplicación del aviso de versión nueva: decide si corresponde preguntar, guarda cuándo se preguntó, y compara lo que contesta GitHub contra lo que está corriendo.</summary>
public sealed class ActualizacionesService
{
    ...
    /// <summary>Pospone el aviso de esa versión hasta mañana.</summary>
    ...
    /// <summary>Levanta la posposición. Buscar actualizaciones a mano es un pedido explícito y manda sobre el «ver después» de antes.</summary>
    public Task OlvidarPosposicionAsync(
        AjustesDeActualizacion ajustes, CancellationToken ct = default) =>
        _ajustes.GuardarAsync(
            ajustes with { VersionPospuesta = null, MomentoDePosposicion = null }, ct);
