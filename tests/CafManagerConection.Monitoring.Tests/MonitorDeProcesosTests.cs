...
public sealed class MonitorDeProcesosTests
{
    ...
    private sealed class RunnerFalso : IEjecutorRemoto
    {
    ...
    // Con el panel de estado y el de procesos abiertos, la muestra se comparte y el servidor lee una sola vez.
    [Fact]
