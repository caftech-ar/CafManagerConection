...
{
    private sealed class RunnerFalso(bool exito, string salida) : IEjecutorConPrivilegios
    {
    ...
    private sealed class RunnerEnDosPasos(string deteccion) : IEjecutorConPrivilegios
    {
