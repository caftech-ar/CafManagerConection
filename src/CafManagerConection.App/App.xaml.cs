...
public partial class App : Application
{
    ...
    private static void InformarFalloDeArranque(Exception ex)
    {
        ...
        try
        {
            // Tipo, mensaje y pila, y no el ToString recursivo: este archivo no pasa por
            // IAppLogger, que es la interfaz cerrada con la que se audita que no se filtren secretos.
            File.WriteAllText(
                destino,
