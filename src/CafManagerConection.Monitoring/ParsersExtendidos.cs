...
/// <summary>Interpreta <c>ip -o addr show</c> e <c>ip -o link show</c>.</summary>
...
/// <summary>Interpreta <c>ip route show</c> e <c>ip -6 route show</c>.</summary>
...
/// <summary>Interpreta <c>/proc/pressure/*</c>.</summary>
