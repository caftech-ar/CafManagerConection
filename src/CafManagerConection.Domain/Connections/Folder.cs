...
public sealed class Folder
{
    ...
    /// <summary><c>null</c> usa el color global del protocolo.</summary>
    public string? ClaveDeColor { get; set; }

    /// <summary><c>null</c> usa el icono de la aplicación. No se hereda.</summary>
    public string? ClaveDeIcono { get; set; }

    /// <summary>Línea corta que acompaña al nombre en el árbol.</summary>
