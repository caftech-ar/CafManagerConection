...
/// <summary>Parte un archivo de nginx en tramos para colorearlo.</summary>
// Los tramos cubren el texto completo, en orden y sin superponerse: concatenarlos devuelve el archivo tal cual.
