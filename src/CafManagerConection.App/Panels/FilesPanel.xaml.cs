...
/// <summary>Explorador de archivos del servidor por SFTP, sobre la misma conexión SSH.</summary>
...
public partial class FilesPanel : UserControl
{
    ...
    /// <summary>La carpeta remota se confirma antes de transferir el primer byte.</summary>
