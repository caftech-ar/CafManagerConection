...
/// <summary>Interpreta <c>/proc/stat</c>. El uso de CPU se calcula por diferencia entre dos lecturas.</summary>
...
/// <summary>Interpreta <c>/proc/meminfo</c>. La usada es <c>MemTotal - MemAvailable</c>, no <c>MemTotal - MemFree</c>.</summary>
...
/// <summary>Interpreta <c>/proc/net/dev</c>. La velocidad se calcula por diferencia entre dos lecturas.</summary>
