...
/// <summary>Un enlace simbólico no se ofrece, y hay que decir cuántos se sacaron.</summary>
...
public sealed class RemoteFileSession : IAsyncDisposable
{
    ...
    /// <summary>Un punto de reanálisis se saltea: seguirlo puede volver sobre sí mismo.</summary>
