    ...
    string? ComposeService = null)
{
    ...
    /// <summary>Con qué gravedad pintar el contenedor.</summary>
...
// Una sola lectura por consulta; el CPU% que informa Docker pasa de 100 % con varios núcleos.
...
/// <summary>Un puerto a la escucha; <c>Process</c> y <c>Pid</c> quedan nulos sin permiso para ver el socket, y <c>Usuario</c> y <c>DirectorioDeTrabajo</c> quedan vacíos cuando el proceso es ajeno y no se pudo leer su <c>/proc</c>.</summary>
