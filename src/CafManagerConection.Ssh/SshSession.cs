...
public sealed class SshSession : IAsyncDisposable
{
    ...
    /// <summary>Conecta. No lanza ante un fallo previsto: pasa a <see cref="SessionState.Error"/> con su motivo.</summary>
    ...
    /// <summary>La contraseña de <c>sudo</c> de esta sesión: nace vacía y se pisa con ceros al cerrarla, así que reabrir la misma conexión la vuelve a pedir.</summary>
    public ContrasenaDeSudoDeSesion ContrasenaDeSudo { get; } = new();

    /// <summary>El resultado del único sondeo de la sesión; null cuando no se pudo preguntar.</summary>
    ...
    /// <summary>Verificación de la clave del host: ocurre en el intercambio de claves, antes de enviar ninguna credencial.</summary>
    ...
    /// <summary>Traduce la excepción a una causa del conjunto cerrado.</summary>
