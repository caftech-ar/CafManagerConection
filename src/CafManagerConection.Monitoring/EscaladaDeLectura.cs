...
/// <summary>Prepara una lectura para que el reintento con privilegios de <c>sudo</c> llegue a hacerse.</summary>
public static class EscaladaDeLectura
{
    // /proc/1/io lo lee sólo root. ss y /proc/<pid>/io no fallan sin privilegios, devuelven menos: sin algo que falle de verdad, SshCommandRunner.RunWithSudoFallbackAsync nunca llega a la rama de sudo.
...
/// <summary>Qué se le dice al usuario en cada resultado del sondeo de <c>sudo</c>.</summary>
