...
/// <summary>La contraseña de <c>sudo</c> mientras esa sesión esté abierta: no se persiste, no viaja por la línea de comandos y el búfer se pisa con ceros al cerrar. Es la única excepción a que no haya secretos en claro.</summary>
