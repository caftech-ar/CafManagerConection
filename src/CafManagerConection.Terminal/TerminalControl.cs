...
public sealed class TerminalControl : Control
{
    ...
    /// <summary>Combinaciones que la aplicación se queda en lugar de mandarlas al servidor.</summary>
    ...
    // Con la barra y el punto entre los separadores, /etc/nginx/nginx.conf se partiría al doble clic en vez de seleccionarse entero.
    ...
    /// <summary>Normaliza CRLF a CR; sin esto cada línea pegada llega duplicada.</summary>
